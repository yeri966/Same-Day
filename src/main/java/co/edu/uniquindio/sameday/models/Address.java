package co.edu.uniquindio.sameday.models.entities;
...
public class Address {
    private String id;                    // Identificador único de la dirección
    private String alias;                 // Nombre descriptivo (ej: "Casa", "Oficina Principal")
    private String street;                // Dirección completa (calle, número, etc.)
    private City city;                    // Municipio del Quindío
    private AddressType type;             // Tipo: Remitente o Destinatario
    private String placeDescription;      // Descripción del lugar (Casa, Oficina, Local, etc.)
    private String additionalInfo;        // Información adicional (torre, apto, piso, etc.)
    ...
    /**
     * Genera una dirección completa formateada
